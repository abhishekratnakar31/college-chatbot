...
export const RSS_FEEDS: FeedSource[] = [
  ...
  GN("university exam results 2025 India result link notification", "Exam Results"),
  GN("top colleges in India ranking NIRF infrastructure campus news 2025", "Colleges News"),
  GN("higher education news India 2025 college university", "India Education"),
  GN("educational technology AI in education learning tools 2025", "EdTech News"),
  GN("student entrepreneurship startup news college funding 2025", "Campus Startups"),
  GN("university sports tournament cricket football India 2025", "College Sports"),
  GN("college entertainment movie culture student life 2025", "Campus Culture"),
  GN("student health wellness mental health university India 2025", "Student Wellness"),
  GN("internship for college students India 2025 recruitment stipend", "Student Internships"),
  GN("government scholarship for college students India 2025 application", "Scholarships India"),
  GN("college scholarship merit fellowship financial aid India 2025", "Campus Scholarships"),
  GN("summer internship engineering medical management India 2025", "Summer Internships"),
